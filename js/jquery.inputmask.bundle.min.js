...
! function(e) {
        ...
        function u(r, s, c) {
            function d(e, t, n) {
                ...
                var a, r, o, s = [],
                    ...
                    u = v();
                do {
                    !0 === e && h().validPositions[l] ? (r = (o = h().validPositions[l]).match, a = o.locator.slice(), s.push(!0 === n ? o.input : !1 === n ? r.nativeDef : G(l, r))) : (r = (o = P(l, a, l - 1)).match, a = o.locator.slice(), (!1 === c.jitMasking || l < u || "number" == typeof c.jitMasking && isFinite(c.jitMasking) && c.jitMasking > l) && s.push(!1 === n ? r.nativeDef : G(l, r))), "auto" === c.keepStatic && r.newBlockMarker && null !== r.fn && (c.keepStatic = l - 1), l++
            ...
            function k(t, n, a, r) {
                ...
                for (g(!0), o = s + 1; o <= v();) {
                    ...
                    if (o < s && (o = s + 1), h().validPositions[o] === i && F(o)) o++;
                    else {
                        var p = P(o);
                        !1 === u && l[s] && l[s].match.def === p.match.def ? (h().validPositions[s] = e.extend(!0, {}, l[s]), h().validPositions[s].input = p.input, delete h().validPositions[o], o++) : A(s, p.match.def) ? !1 !== j(s, p.input || G(o), !0) && (delete h().validPositions[o], o++, u = !0) : F(o) || (o++, s--), s++
                    }
                }
                g(!0)
            }
            ...
            function x(e, t) {
                for (var n = (e.alternation != i ? e.mloc[b(e)] : e.locator).join(""); n.length < t;) n += "0";
                return n
            }

            function P(e, t, n) {
                return h().validPositions[e] || y(e, C(e, t ? t.slice() : t, n))
            }
            ...
            function _(t, n, a, r, o) {
                var s, l, u, p, f, m, d, k = e.extend(!0, {}, h().validPositions),
                    y = !1,
                    x = o !== i ? o : v();
                if (-1 === x && o === i) l = (p = S(s = 0)).alternation;
                else
                    for (p = h().validPositions[x]; x >= 0; x--)
                        if ((u = h().validPositions[x]) && u.alternation !== i) {
                    ...
                    var P = [],
                        A = 0;
                    for (f = d; f < v(i, !0) + 1; f++)(m = h().validPositions[f]) && !0 !== m.generatedInput && /[0-9a-bA-Z]/.test(m.input) ? P.push(m.input) : f < t && A++, delete h().validPositions[f];
                    for (; h().excludes[d] && h().excludes[d].length < 10;) {
                        var C = -1 * A,
                            M = P.slice();
                        for (h().tests[d] = i, g(!0), y = !0; M.length > 0;) {
                            var E = M.shift();
                            if (E !== c.skipOptionalPartCharacter && !(y = j(v(i, !0) + 1, E, !1, r, !0))) break
                        }
                        if (y && n !== i) {
                            var w = v(t) + 1;
                            for (f = d; f < v() + 1; f++)((m = h().validPositions[f]) === i || null == m.match.fn) && f < t + C && C++;
                            y = j((t += C) > w ? w : t, n, a, r, !0)
                        }
                        if (y) break;
                        ...
                        for (h().excludes[d].push(D), f = d; f < v(i, !0) + 1; f++) delete h().validPositions[f]
                    }
                }
                return h().excludes[d] = i, y
            }

            function j(t, n, r, o, s, l) {
                function u(e) {
                ...
                function p(n, a, r) {
                    var s = !1;
                    return e.each(C(n), function(l, p) {
                        var m = p.match;
                        if (E(!0), !1 !== (s = null != m.fn ? m.fn.test(a, h(), n, r, c, u(t)) : (a === m.def || a === c.skipOptionalPartCharacter) && "" !== m.def && {
                                c: G(n, m, !0) || m.def,
                                pos: n
                            })) {
                            var d = s.c !== i ? s.c : a;
                            d = d === c.skipOptionalPartCharacter && null === m.fn ? G(n, m, !0) || m.def : d;
                            var y = n,
                                b = E();
                            if (s.remove !== i && (e.isArray(s.remove) || (s.remove = [s.remove]), e.each(s.remove.sort(function(e, t) {
                                ...
                                if (w(!0 === x ? x : x.start, x.end, b), s.pos === i && s.c === i) return s.pos = v(), !1;
                                if ((y = s.pos !== i ? s.pos : n) !== n) return s = e.extend(s, j(y, d, !0, o)), !1
                            } else if (!0 !== s && s.pos !== i && s.pos !== n && (y = s.pos, w(n, y, E().slice()), y !== n)) return s = e.extend(s, j(y, d, !0)), !1;
                        ...
                        for (o = u = t; o <= l; o++) {
                            ...
                            if (y !== i)
                                for (var b = u; b < h().maskLength && (null === y.match.fn && f[o] && (!0 === f[o].match.optionalQuantifier || !0 === f[o].match.optionality) || null != y.match.fn);) {
                                    ...
                                    else if (A(b, y.match.def)) {
                                        var x = j(b, y.input, !0, !0);
                ...
                function m(t) {
                    ...
                    var a, r;
                    for (n++; n < t; n++) h().validPositions[n] === i && (!1 === c.jitMasking || c.jitMasking > n) && ("" === (r = C(n, P(n - 1).locator, n - 1).slice())[r.length - 1].match.def && r.pop(), (a = y(n, r)) && (a.match.def === c.radixPointDefinitionSymbol || !F(n, !0) || e.inArray(c.radixPoint, E()) < n && a.match.fn && a.match.fn.test(G(n), h(), n, !1, c)) && !1 !== (b = p(n, G(n, a.match, !0) || (null == a.match.fn ? a.match.def : "" !== G(n) ? G(n) : E()[n]), !0)) && (h().validPositions[b.pos || n].generatedInput = !0))
                }
                r = !0 === r;
                var d = t;
                t.begin !== i && (d = X && !u(t) ? t.end : t.begin);
                var b = !0,
                    M = e.extend(!0, {}, h().validPositions);
                if (e.isFunction(c.preValidation) && !r && !0 !== o && !0 !== l && (b = c.preValidation(E(), d, n, u(t), c)), !0 === b) {
                    if (m(d), u(t) && (U(i, a.keyCode.DELETE, t, !0, !0), d = h().p), d < h().maskLength && (q === i || d < q) && (b = p(d, n, r), (!r || !0 === o) && !1 === b && !0 !== l)) {
                        var O = h().validPositions[d];
                        if (!O || null !== O.match.fn || O.match.def !== n && n !== c.skipOptionalPartCharacter) {
                            if ((c.insertMode || h().validPositions[T(d)] === i) && !F(d, !0))
                                for (var N = d + 1, R = T(d); N <= R; N++)
                                    if (!1 !== (b = p(N, n, r))) {
                                        b = function(t, n) {
                                            var a;
                                            t === i && (t = v());
                                            for (var r = t; r < n; r++)
                                                if (h().validPositions[r] === i && !F(r, !0)) {
                                                    var o = 0 == r ? S(r) : h().validPositions[r - 1];
                                                    if (o) {
                                                        var s, l, u, c = x(o),
                                                            p = C(r).slice();
                                                        "" === p[p.length - 1].match.def && p.pop(), e.each(p, function(e, t) {
                                                            s = x(t, c.length);
                                                            var n = Math.abs(s - c);
                                                            (l === i || n < l) && null === t.match.fn && !0 !== t.match.optionality && !0 !== t.match.optionalQuantifier && (l = n, u = t)
                                                        }), (u = e.extend({}, u, {
                                                            input: G(r, u.match, !0) || u.match.def
                                                        })).generatedInput = !0, f(r, u, !0);
                                                        var m = h().validPositions[n].input;
                                                        h().validPositions[n] = i, a = j(n, m, !0, !0)
                                                    }
                                                } return a
                                        }(d, b.pos !== i ? b.pos : N) || b, d = N;
                                        break
                                    }
                        } else b = {
                            caret: T(d)
                        }
                    }!1 !== b || !1 === c.keepStatic || r || !0 === s || (b = _(d, n, r, o)), !0 === b && (b = {
                        pos: d
                    })
                }
                if (e.isFunction(c.postValidation) && !1 !== b && !r && !0 !== o && !0 !== l) {
                    var B = c.postValidation(E(!0), b, c);
                    if (B !== i) {
                        if (B.refreshFromBuffer && B.buffer) {
                            var I = B.refreshFromBuffer;
                            w(!0 === I ? I : I.start, I.end, B.buffer)
                        }
                        b = !0 === B ? b : B
                    }
                }
                return b && b.pos === i && (b.pos = d), !1 !== b && !0 !== l || (g(!0), h().validPositions = e.extend(!0, {}, M)), b
            }
            ...
            function T(e, t) {
                ...
                if (e >= n) return n;
                var i = e;
                for (C(n + 1).length > 1 && (n = d(!0, n + 1, !1).kength); ++i < n && (!0 === t && (!0 !== S(i).match.newBlockMarker || !F(i)) || !0 !== t && !F(i)););
                return i
            }
            ...
            function N(e, t) {
                var n, i = e;
                if (i <= 0) return 0;
                for (; --i > 0 && (!0 === t && !0 !== S(i).match.newBlockMarker || !0 !== t && !F(i) && ((n = C(i)).length < 2 || 2 === n.length && "" === n[1].match.def)););
                return i
            }

            function R(t, n, a, r, o) {
                if (r && e.isFunction(c.onBeforeWrite)) {
                    var s = c.onBeforeWrite.call(J, r, n, a, c);
                    if (s) {
                ...
                t !== i && (t.inputmask._valueSet(n.join("")), a === i || r !== i && "blur" === r.type ? Q(t, a, 0 === n.length) : L(t, a), !0 === o && (te = !0, e(t).trigger("input")))
            }

            function G(t, n, a) {
                if ((n = n || S(t).match).placeholder !== i || !0 === a) return e.isFunction(n.placeholder) ? n.placeholder(c) : n.placeholder;
                if (null === n.fn) {
            ...
            function B(t, n, r, o, s) {
                function l(e, t) {
                    return -1 !== d(!0, 0, !1).slice(e, T(e)).join("").indexOf(t) && !F(e) && (S(e).match.nativeDef === t.charAt(0) || " " === S(e).match.nativeDef && S(e + 1).match.nativeDef === t.charAt(0))
                }
                var u = o.slice(),
                    p = "",
                    f = -1,
                ...
                if (g(), r || !0 === c.autoUnmask) f = T(f);
                    ...
                    var k = M().slice(0, T(-1)).join(""),
                        y = u.join("").match(new RegExp("^" + a.escapeRegex(k), "g"));
                    y && y.length > 0 && (u.splice(0, y.length * k.length), f = T(f))
                } - 1 === f ? (h().p = T(f), f = 0) : h().p = f, e.each(u, function(n, a) {
                    if (a !== i)
                        if (h().validPositions[n] === i && u[n] === G(n) && F(n, !0) && !1 === j(n, u[n], !0, i, i, !0)) h().p++;
                        else {
                            var o = new e.Event("_checkval");
                            o.which = a.charCodeAt(0), p += a;
                            var s = v(i, !0),
                                d = S(s),
                                g = P(s + 1, d ? d.locator.slice() : i, s);
                            if (!l(f, p) || r || c.autoUnmask) {
                                var k = r ? n : null == g.match.fn && g.match.optionality && s + 1 < h().p ? s + 1 : h().p;
                                (m = oe.keypressEvent.call(t, o, !0, !1, r, k)) && (f = k + 1, p = "")
                            } else m = oe.keypressEvent.call(t, o, !0, !1, !0, s + 1);
                            R(i, E(), m.forwardPosition, o, !1)
                        }
                }), n && R(t, E(), m ? m.forwardPosition : i, s || new e.Event("checkval"), s && "input" === s.type)
            }
            ...
            function L(a, r, o, s) {
                ...
                if (e.isArray(r) && (o = X ? r[0] : r[1], r = X ? r[1] : r[0]), r.begin !== i && (o = X ? r.begin : r.end, r = X ? r.end : r.begin), "number" == typeof r) {
            ...
            function H(t) {
                ...
                for (n = s + 1; n < r.length; n++) c = (a = P(n, c, n - 1)).locator.slice(), l[n] = e.extend(!0, {}, a);
                var p = u && u.alternation !== i ? u.locator[u.alternation] : i;
                for (n = o - 1; n > s && (((a = l[n]).match.optionality || a.match.optionalQuantifier && a.match.newBlockMarker || p && (p !== l[n].locator[u.alternation] && null != a.match.fn || null === a.match.fn && a.locator[u.alternation] && O(a.locator[u.alternation].toString().split(","), p.toString().split(",")) && "" !== C(n)[0].def)) && r[n] === G(n, a.match)); n--) o--;
                return t ? {
                    l: o,
                    def: l[o] ? l[o].match : i
                } : o
            ...
            function V(e) {
                for (var t, n = H(), a = e.length, r = h().validPositions[v()]; n < a && !F(n, !0) && (t = r !== i ? P(n, r.locator.slice(""), r) : S(n)) && !0 !== t.match.optionality && (!0 !== t.match.optionalQuantifier && !0 !== t.match.newBlockMarker || n + 1 === a && "" === (r !== i ? P(n + 1, r.locator.slice(""), r) : S(n + 1)).match.def);) n++;
                for (;
            ...
            function K(t) {
                ...
                if (a.def === i || a.def.newBlockMarker || a.def.optionality || a.def.optionalQuantifier) {
                    ...
                    for (var o = 0; o <= r; o++) {
                        var s = P(o).match;
                        if (null !== s.fn && h().validPositions[o] === i && !0 !== s.optionality && !0 !== s.optionalQuantifier || null === s.fn && t[o] !== G(o, s)) {
                            n = !1;
                            break
                        }
                    }
            ...
            function U(e, t, n, r, o) {
                ...
                if (t === a.keyCode.BACKSPACE && (n.end - n.begin < 1 || !1 === c.insertMode) ? (n.begin = N(n.begin), h().validPositions[n.begin] !== i && h().validPositions[n.begin].input === c.groupSeparator && n.begin--) : t === a.keyCode.DELETE && n.begin === n.end && (n.end = F(n.end, !0) && h().validPositions[n.end] && h().validPositions[n.end].input !== c.radixPoint ? n.end + 1 : T(n.end) + 1, h().validPositions[n.begin] !== i && h().validPositions[n.begin].input === c.groupSeparator && n.end++), k(n.begin, n.end, !1, r), !0 !== r && c.keepStatic) {
                    var l = _(!0);
                    l && (n.begin = l.caret !== i ? l.caret : l.pos ? T(l.pos.begin ? l.pos.begin : l.pos) : v(-1, !0))
                }
                var u = v(n.begin, !0);
                if (u < n.begin) h().p = T(u);
            ...
            function z(i) {
                ...
                o.style.width = r.width, o.style.textAlign = r.textAlign, Z = n.createElement("div"), i.inputmask.colorMask = Z, Z.className = "im-colormask", i.parentNode.insertBefore(Z, i), i.parentNode.removeChild(i), Z.appendChild(o), Z.appendChild(i), i.style.left = o.offsetLeft + "px", e(i).on("click", function(e) {
                    return L(i, a(e.clientX)), oe.clickEvent.call(i, [e])
            ...
            function Q(e, t, a) {
                ...
                if (Z !== i) {
                    var m = E();
                    if (t === i ? t = L(e) : t.begin === i && (t = {
                            begin: t,
                            end: t
                        }), !0 !== a) {
                        var d = v();
                        do {
                            h().validPositions[f] ? (s = h().validPositions[f], o = s.match, l = s.locator.slice(), r(m[f])) : (s = P(f, l, f - 1), o = s.match, l = s.locator.slice(), (!1 === c.jitMasking || f < d || "number" == typeof c.jitMasking && isFinite(c.jitMasking) && c.jitMasking > f) && r(G(f, o))), f++
                ...
                oe = {
                    keydownEvent: function(t) {
                        var n = this,
                            ...
                            r = t.keyCode,
                            o = L(n);
                        if (r === a.keyCode.BACKSPACE || r === a.keyCode.DELETE || m && r === a.keyCode.BACKSPACE_SAFARI || t.ctrlKey && r === a.keyCode.X && !l("cut")) t.preventDefault(), U(0, r, o), R(n, E(!0), h().p, t, n.inputmask._valueGet() !== E().join("")), n.inputmask._valueGet() === M().join("") ? i.trigger("cleared") : !0 === K(E()) && i.trigger("complete");
                        else if (r === a.keyCode.END || r === a.keyCode.PAGE_DOWN) {
                            t.preventDefault();
                            var s = T(v());
                            c.insertMode || s !== h().maskLength || t.shiftKey || s--, L(n, t.shiftKey ? o.begin : s, s, !0)
                        } else r === a.keyCode.HOME && !t.shiftKey || r === a.keyCode.PAGE_UP ? (t.preventDefault(), L(n, 0, t.shiftKey ? o.begin : 0, !0)) : (c.undoOnEscape && r === a.keyCode.ESCAPE || 90 === r && t.ctrlKey) && !0 !== t.altKey ? (B(n, !0, !1, W.split("")), i.trigger("click")) : r !== a.keyCode.INSERT || t.shiftKey || t.ctrlKey ? !0 === c.tabThrough && r === a.keyCode.TAB ? (!0 === t.shiftKey ? (null === S(o.begin).match.fn && (o.begin = T(o.begin)), o.end = N(o.begin, !0), o.begin = N(o.end, !0)) : (o.begin = T(o.begin, !0), o.end = T(o.begin, !0), o.end < h().maskLength && o.end--), o.begin < h().maskLength && (t.preventDefault(), L(n, o.begin, o.end))) : t.shiftKey || !1 === c.insertMode && (r === a.keyCode.RIGHT ? setTimeout(function() {
                            var e = L(n);
                            L(n, e.begin)
                        }, 0) : r === a.keyCode.LEFT && setTimeout(function() {
                            var e = L(n);
                            L(n, X ? e.begin + 1 : e.begin - 1)
                        }, 0)) : (c.insertMode = !c.insertMode, L(n, c.insertMode || o.begin !== h().maskLength ? o.begin : o.begin - 1));
                        c.onKeyDown.call(this, t, E(), L(n).begin, c), ne = -1 !== e.inArray(r, c.ignorables)
                    },
                    keypressEvent: function(t, n, r, o, s) {
                        var l = this,
                            u = e(l),
                            p = t.which || t.charCode || t.keyCode;
                        if (!(!0 === n || t.ctrlKey && t.altKey) && (t.ctrlKey || t.metaKey || ne)) return p === a.keyCode.ENTER && W !== E().join("") && (W = E().join(""), setTimeout(function() {
                            u.trigger("change")
                        }, 0)), !0;
                        if (p) {
                            ...
                            h().writeOutBuffer = !0;
                            var v = j(m, d, o);
                            if (!1 !== v && (g(!0), f = v.caret !== i ? v.caret : T(v.pos.begin ? v.pos.begin : v.pos), h().p = f), f = c.numericInput && v.caret === i ? N(f) : f, !1 !== r && (setTimeout(function() {
                                    c.onKeyValidation.call(l, p, v, c)
                                }, 0), h().writeOutBuffer && !1 !== v)) {
                                var k = E();
                                R(l, k, f, t, !0 !== n), !0 !== n && setTimeout(function() {
                                    !0 === K(k) && u.trigger("complete")
                                }, 0)
                            }
                    ...
                    pasteEvent: function(n) {
                        var i, a = this,
                            ...
                            l = L(a);
                        X && (i = l.end, l.end = l.begin, l.begin = i);
                        var u = s.substr(0, l.begin),
                            p = s.substr(l.end, s.length);
                        if (u === (X ? M().reverse() : M()).slice(0, l.begin).join("") && (u = ""), p === (X ? M().reverse() : M()).slice(l.end).join("") && (p = ""), X && (i = u, u = p, p = i), t.clipboardData && t.clipboardData.getData) s = u + t.clipboardData.getData("Text") + p;
                        else {
                        ...
                        if (e.isFunction(c.onBeforePaste)) {
                            if (!1 === (f = c.onBeforePaste.call(J, s, c))) return n.preventDefault();
                            f || (f = s)
                        }
                        return B(a, !1, !1, X ? f.split("").reverse() : f.toString().split("")), R(a, E(), T(v()), n, W !== E().join("")), !0 === K(E()) && o.trigger("complete"), n.preventDefault()
                    },
                    inputFallBackEvent: function(t) {
                        ...
                        if (E().join("") !== i) {
                            ...
                            if (i = function(e, t, n) {
                                ...
                                if (u !== m && (u.length > m.length ? h += u.slice(0, 1) : u.length < m.length && (d.end += m.length - u.length, g || "" === c.radixPoint || "" !== u || l.charAt(d.begin + s - 1) !== c.radixPoint || (d.begin--, h = c.radixPoint))), R(n, E(), {
                                        begin: d.begin + s,
                                        end: d.end + s
                                    }), h.length > 0) e.each(h.split(""), function(t, i) {
                                    var a = new e.Event("keypress");
                                    a.which = i.charCodeAt(0), ne = !1, oe.keypressEvent.call(n, a)
                                });
                                else {
                                    d.begin === d.end - 1 && (d.begin = N(d.begin + 1), d.begin === d.end - 1 ? L(n, d.begin) : L(n, d.begin, d.end));
                                    var y = new e.Event("keydown");
                                    y.keyCode = a.keyCode.DELETE, oe.keydownEvent.call(n, y), !1 === c.insertMode && L(n, L(n).begin - 1)
                                }
                                t.preventDefault()
                            }
                        }
                    ...
                    setValueEvent: function(t) {
                        ...
                        e.isFunction(c.onBeforeMask) && (i = c.onBeforeMask.call(J, i, c) || i), i = i.split(""), B(n, !0, !1, X ? i.reverse() : i), W = E().join(""), (c.clearMaskOnLostFocus || c.clearIncomplete) && n.inputmask._valueGet() === M().join("") && n.inputmask._valueSet("")
                    },
                    focusEvent: function(e) {
                        var t = this,
                            n = t.inputmask._valueGet();
                        c.showMaskOnFocus && (!c.showMaskOnHover || c.showMaskOnHover && "" === n) && (t.inputmask._valueGet() !== E().join("") ? R(t, E(), T(v())) : !1 === ie && L(t, T(v()))), !0 === c.positionCaretOnTab && !1 === ie && oe.clickEvent.apply(t, [e, !0]), W = E().join("")
                    },
                    mouseleaveEvent: function(e) {
                        var t = this;
                        if (ie = !1, c.clearMaskOnLostFocus && n.activeElement !== t) {
                            var i = E().slice(),
                                a = t.inputmask._valueGet();
                            a !== t.getAttribute("placeholder") && "" !== a && (-1 === v() && a === M().join("") ? i = [] : V(i), R(t, i))
                        }
                    },
                    clickEvent: function(t, a) {
                        ...
                        setTimeout(function() {
                            if (n.activeElement === o) {
                                var e = L(o);
                                if (a && (X ? e.end = e.begin : e.begin = e.end), e.begin === e.end) switch (c.positionCaretOnClick) {
                                    case "none":
                                        break;
                                    case "select":
                                        L(o, 0, E().length);
                                    ...
                                    case "radixFocus":
                                        ...
                                        default:
                                            var s = e.begin,
                                                l = v(s, !0),
                                                u = T(l);
                                            if (s < u) L(o, F(s, !0) || F(s - 1, !0) ? s : T(s));
                                            else {
                                                var p = h().validPositions[l],
                                                    f = P(u, p ? p.match.locator : i, p),
                                                    m = G(u, f.match);
                                                if ("" !== m && E()[u] !== m && !0 !== f.match.optionalQuantifier && !0 !== f.match.newBlockMarker || !F(u, !0) && f.match.def === m) {
                                                    var d = T(u);
                                                    (s >= d || s === u) && (u = d)
                                                }
                                                L(o, u)
                    ...
                    cutEvent: function(i) {
                        var r = this,
                            ...
                            c = X ? E().slice(s.end, s.begin) : E().slice(s.begin, s.end);
                        u.setData("text", X ? c.reverse().join("") : c.join("")), n.execCommand && n.execCommand("copy"), U(0, a.keyCode.DELETE, s), R(r, E(), h().p, i, W !== E().join("")), r.inputmask._valueGet() === M().join("") && o.trigger("cleared")
                    },
                    blurEvent: function(t) {
                        ...
                        if (a.inputmask) {
                            var r = a.inputmask._valueGet(),
                                o = E().slice();
                            "" === r && Z === i || (c.clearMaskOnLostFocus && (-1 === v() && r === M().join("") ? o = [] : V(o)), !1 === K(o) && (setTimeout(function() {
                                n.trigger("incomplete")
                            }, 0), c.clearIncomplete && (g(), o = c.clearMaskOnLostFocus ? [] : M().slice())), R(a, o, i, t)), W !== E().join("") && (W = o.join(""), n.trigger("change"))
                        }
                    },
                    mouseenterEvent: function(e) {
                        var t = this;
                        ie = !0, n.activeElement !== t && c.showMaskOnHover && t.inputmask._valueGet() !== E().join("") && R(t, E())
                    },
                    submitEvent: function(e) {
                        W !== E().join("") && $.trigger("change"), c.clearMaskOnLostFocus && -1 === v() && Y.inputmask._valueGet && Y.inputmask._valueGet() === M().join("") && Y.inputmask._valueSet(""), c.removeMaskOnSubmit && (Y.inputmask._valueSet(Y.inputmask.unmaskedvalue(), !0), setTimeout(function() {
                            R(Y, E())
                        }, 0))
                    },
            ...
            if (r !== i) switch (r.action) {
                case "isComplete":
                    return Y = r.el, K(E());
                case "unmaskedvalue":
                    return Y !== i && r.value === i || (se = r.value, se = (e.isFunction(c.onBeforeMask) ? c.onBeforeMask.call(J, se, c) || se : se).split(""), B(i, !1, !1, X ? se.reverse() : se), e.isFunction(c.onBeforeWrite) && c.onBeforeWrite.call(J, i, E(), 0, c)), I(Y);
                case "mask":
                    ! function(t) {
                        re.off(t);
                        var a = function(t, a) {
                            ...
                            return !1 !== s ? function(t) {
                                function r() {
                                    return this.inputmask ? this.inputmask.opts.autoUnmask ? this.inputmask.unmaskedvalue() : -1 !== v() || !0 !== a.nullable ? n.activeElement === this && a.clearMaskOnLostFocus ? (X ? V(E().slice()).reverse() : V(E().slice())).join("") : l.call(this) : "" : l.call(this)
                                }
                                ...
                                if (!t.inputmask.__valueGet) {
                                    ...
                                    t.inputmask._valueGet = function(e) {
                                        ...
                                        u.call(this.el, null === e || e === i ? "" : !0 !== t && X ? e.split("").reverse().join("") : e)
                                    }, l === i && (l = function() {
                                        return this.value
                                    }, u = function(e) {
                                        this.value = e
                        ...
                        if (!1 !== a && (Y = t, $ = e(Y), -1 === (q = Y !== i ? Y.maxLength : i) && (q = i), !0 === c.colorMask && z(Y), p && ("inputmode" in Y && (Y.inputmode = c.inputmode, Y.setAttribute("inputmode", c.inputmode)), !0 === c.disablePredictiveText && ("autocorrect" in Y ? Y.autocorrect = !1 : (!0 !== c.colorMask && z(Y), Y.type = "password"))), !0 === a && (re.on(Y, "submit", oe.submitEvent), re.on(Y, "reset", oe.resetEvent), re.on(Y, "mouseenter", oe.mouseenterEvent), re.on(Y, "blur", oe.blurEvent), re.on(Y, "focus", oe.focusEvent), re.on(Y, "mouseleave", oe.mouseleaveEvent), !0 !== c.colorMask && re.on(Y, "click", oe.clickEvent), re.on(Y, "dblclick", oe.dblclickEvent), re.on(Y, "paste", oe.pasteEvent), re.on(Y, "dragdrop", oe.pasteEvent), re.on(Y, "drop", oe.pasteEvent), re.on(Y, "cut", oe.cutEvent), re.on(Y, "complete", c.oncomplete), re.on(Y, "incomplete", c.onincomplete), re.on(Y, "cleared", c.oncleared), p || !0 === c.inputEventOnly ? Y.removeAttribute("maxLength") : (re.on(Y, "keydown", oe.keydownEvent), re.on(Y, "keypress", oe.keypressEvent)), re.on(Y, "compositionstart", e.noop), re.on(Y, "compositionupdate", e.noop), re.on(Y, "compositionend", e.noop), re.on(Y, "keyup", e.noop), re.on(Y, "input", oe.inputFallBackEvent), re.on(Y, "beforeinput", e.noop)), re.on(Y, "setvalue", oe.setValueEvent), W = M().join(""), "" !== Y.inputmask._valueGet(!0) || !1 === c.clearMaskOnLostFocus || n.activeElement === Y)) {
                            var r = e.isFunction(c.onBeforeMask) ? c.onBeforeMask.call(J, Y.inputmask._valueGet(!0), c) || Y.inputmask._valueGet(!0) : Y.inputmask._valueGet(!0);
                            "" !== r && B(Y, !0, !1, X ? r.split("").reverse() : r.split(""));
                            var s = E().slice();
                            W = s.join(""), !1 === K(s) && c.clearIncomplete && g(), c.clearMaskOnLostFocus && n.activeElement !== Y && (-1 === v() ? s = [] : V(s)), R(Y, s), n.activeElement === Y && L(Y, T(v()))
                        }
                    }(Y);
                    break;
                case "format":
                    return se = (e.isFunction(c.onBeforeMask) ? c.onBeforeMask.call(J, r.value, c) || r.value : r.value).split(""), B(i, !0, !1, X ? se.reverse() : se), r.metadata ? {
                ...
                case "isValid":
                    r.value ? (se = r.value.split(""), B(i, !0, !0, X ? se.reverse() : se)) : r.value = E().join("");
                    for (var le = E(), ue = H(), ce = le.length - 1; ce > ue && !F(ce); ce--);
                    return le.splice(ue, ce + 1 - ue), K(le) && r.value === E().join("");
                case "getemptymask":
                    return M().join("");
                case "remove":
                    if (Y && Y.inputmask) {
                        $ = e(Y), Y.inputmask._valueSet(c.autoUnmask ? I(Y) : Y.inputmask._valueGet(!0)), re.off(Y), Y.inputmask.colorMask && ((Z = Y.inputmask.colorMask).removeChild(Y), Z.parentNode.insertBefore(Y, Z), Z.parentNode.removeChild(Z));
    ...
    ! function(o) {
        ...
        function r(e, t, i) {
            for (var a, r = ""; a = n(i).exec(e);) void 0 === t ? r += l[a[0]] ? "(" + l[a[0]][0] + ")" : a[0] : l[a[0]] ? r += l[a[0]][3].call(t.date) : r += a[0];
            return r
        }
    ...
    ! function(o) {
        ...
        return t.prototype.analyseMask = function(t, n, a) {
            ...
            function o(t) {
                ...
                return 1 === i.length ? n += i[0] : n += a.groupmarker[0] + i.join(a.groupmarker[1] + a.alternatormarker + a.groupmarker[0]) + a.groupmarker[1], n
            }
            var s = {};
